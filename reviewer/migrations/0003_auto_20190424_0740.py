...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='course',
            name='coreqs',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='course_coreqs', to='reviewer.Course'),
        ),
        migrations.AddField(
            model_name='course',
            name='lastupdated',
        ...
        migrations.AddField(
            model_name='course',
            name='prereqs',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='course_prereqs', to='reviewer.Course'),
        ),
        migrations.CreateModel(
            name='Reply',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reviewer.Lessons')),
            ],
        ),
        migrations.CreateModel(
            name='Modules',
